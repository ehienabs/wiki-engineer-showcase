...
const Footer = () => {
  return (
    <footer className="bg-wikimedia-dark text-white py-12">
      <div className="section-container">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/ehienabs" className="hover:text-wikimedia-accent transition-colors" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/ehienabs" className="hover:text-wikimedia-accent transition-colors" target="_blank" rel="noopener noreferrer">
